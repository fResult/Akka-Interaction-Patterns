...
public class CoffeeMachineTests {
    ...
    public void shouldSendReadySignalToBarista() {
        ...
        probe.expectMessageClass(CoffeeMachine.CoffeeIsReady.class, Duration.ofMillis(BREWING_DURATION_Millis+100));

        testKit.stop(coffeeMachine);
    }


    // Once a full cycle is completed => Barista pick-up the coffee, CoffeeMachine is back to idle state.
    ...
    public void shouldNotProcessCoffeesUntilReset() {
        ...
        probe.expectMessageClass(CoffeeMachine.CoffeeIsReady.class, Duration.ofMillis(BREWING_DURATION_Millis+1000));
        // Then the CoffeeMachine stay in its state 'coffee ready' (the second brew coffee command was ignored),
