...
public class CoffeeMachine {
    ...
    public static final class BrewCoffee implements CoffeeMachineCommand {
        ...
        public BrewCoffee(
                Coffee coffee,
                ActorRef<Barista.BaristaCommand> replyTo
    ...
    private static Behavior<CoffeeMachineCommand> brewing(final ActorContext<CoffeeMachineCommand> context, Coffee coffee) {
